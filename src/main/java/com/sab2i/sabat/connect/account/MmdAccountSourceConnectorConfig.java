...
// TODO: Clean this up (we do not need a lot of params here)
class MmdAccountSourceConnectorConfig extends SpoolDirSourceConnectorConfig {
    ...
    public MmdAccountSourceConnectorConfig(final boolean isTask, Map<String, ?> settings) {
        ...
        String charsetName = this.getString(MmdAccountSourceConnectorConfig.CSV_CHARSET_CONF);
    ...
    static final ConfigDef conf() {
        ...
        return SpoolDirSourceConnectorConfig.config()
                .define(
                        ConfigKeyBuilder.of(CSV_CHARSET_CONF, ConfigDef.Type.STRING) // TODO: Rename to MMV
